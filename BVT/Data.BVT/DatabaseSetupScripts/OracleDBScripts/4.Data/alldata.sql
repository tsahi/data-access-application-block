...
Insert into Country (COUNTRYCODE, COUNTRYNAME) Values ('US', 'UnitedStates');
...
Insert into Customers
 ...
 Values
   ('FISSA', 'FISSA Fabrica Inter. Salchichas S.A.', 'Diego Roel', 'Accounting Manager', 
    'C/ Moralzarzal, 86', 'Madrid', NULL, '28034', 'Spain', 
...
Insert into Customers
   (CUSTOMERID, COMPANYNAME, CONTACTNAME, CONTACTTITLE, ADDRESS, CITY, REGION, POSTALCODE, COUNTRY, PHONE, FAX)
 Values
   ('LACOR', 'La corne dabondance', 'Daniel Tonini', 'Sales Representative', 
    '67, avenue de lEurope', 'Versailles', NULL, '78000', 'France', 
    '30.59.84.10', '30.59.85.11');
Insert into Customers
   (CUSTOMERID, COMPANYNAME, CONTACTNAME, CONTACTTITLE, ADDRESS, CITY, REGION, POSTALCODE, COUNTRY, PHONE, FAX)
 Values
   ('LAMAI', 'La maison dAsie', 'Annette Roulet', 'Sales Manager', 
...
Insert into Customers
   (CUSTOMERID, COMPANYNAME, CONTACTNAME, CONTACTTITLE, ADDRESS, CITY, REGION, POSTALCODE, COUNTRY, PHONE, FAX)
 Values
   ('LETSS', 'Lets Stop N Shop', 'Jaime Yorres', 'Owner', 
...
Insert into Customers
   (CUSTOMERID, COMPANYNAME, CONTACTNAME, CONTACTTITLE, ADDRESS, CITY, REGION, POSTALCODE, COUNTRY, PHONE, FAX)
 Values
   ('TRAIH', 'Trails Head Gourmet Provisioners', 'Helvetius Nagy', 'Sales Associate', 
...
Insert into Customers
 ...
 Values
   ('VINET', 'Vins et alcools Chevalier', 'Paul Henriot', 'Accounting Manager', 
    '59 rue de lAbbaye', 'Reims', NULL, '51100', 'France', 
...
Insert into debits (DEBITID, ACCOUNTID, AMOUNT) Values (1, '1', 1000);
Insert into debits (DEBITID, ACCOUNTID, AMOUNT) Values (2, '1', 2000);
Insert into debits (DEBITID, ACCOUNTID, AMOUNT) Values (3, '2', 3000);
Insert into debits (DEBITID, ACCOUNTID, AMOUNT) Values (4, '3', 4000);
Insert into debits (DEBITID, ACCOUNTID, AMOUNT) Values (5, '5', 5000);
commit;
